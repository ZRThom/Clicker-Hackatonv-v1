document.addEventListener('DOMContentLoaded', function() {
    ...
    /**
     * Updates the symbol displayed on a panel toggle button (>, <, ^, v) based on its state (opened/closed).
     * 
     * @param {HTMLElement} panel - The container element of the panel.
     * @param {HTMLElement} button - The button used to toggle the panel's state.
     */
    ...
    /**
     * Displays a floating text animation with a random vertical offset.
     * 
    ...
    // add btn (to-add)
    /**
     * Updates all user interface elements (counters, buttons, costs).
     * This function is called every time a game state variable changes.
     */
    function updateUI()
    {
    ...
    // display all number
    /**
     * Formats a number for display, keeping exactly 1 decimal place if it's not an integer.
     * 
     * @param {number} value - The numeric value to format.
     * @returns {number|string} The formatted number ready to be displayed.
     */
    ...
    /**
     * Manages the auto-save feature. 
     * If enabled, saves the game state to localStorage every 10 seconds.
     */
    ...
    // add btn (to-add)
    /**
     * Main function triggered when the player clicks.
     * Calculates gains, checks for potential "super clicks," and updates currencies.
     */
    function clicking()
    {
        playClickSound();
    ...
    /**
     * Resets the entire game state, clears the intervals, and removes the local save.
     */
    // add btn (to-add)
    ...
    // special click
    /**
     * Attempts to trigger a "Super Click" based on the probability (superClickChance).
     * 
     * @param {number} baseGain - The base amount generated by the click.
     * @returns {number} The final gain, potentially increased by the super click value.
     */
    ...
    /**
     * Triggers a project reset if all project cases have been bought, incrementing the server level.
     */
    ...
    /**
     * Serializes the current game state and settings, then saves them to the browser's localStorage.
     * @throws {Error} Logs an error to the console if saving fails.
     */
    ...
    // add btn (to-add)
    /**
     * Generates a JSON file containing the full game save and triggers its download.
     * Allows players to export their progression.
     */
    ...
    /**
     * Switches the display to a specific UI layer (Main Menu, Game, Settings, Credits).
     * 
     * @param {string} name - The CSS class name of the layer to display.
     */
    ...
    /**
     * Plays the appropriate background music for the given UI layer and pauses any existing audio.
     * 
     * @param {string} layerName - The name of the layer to play music for.
     */
